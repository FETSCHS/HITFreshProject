...
from sql import *
#sys.setrecursionlimit(10**3)  # set the maximum depth as 10的10次方
...
class MainWindow(QtGui.QWidget):
    def __init__(self, rowCount, parent=None):
        ...
        self.slavewindow = [0 for x in range(270)]
    ...
    def initUI(self):
        ...
        #names = ['01','02','03','04','05','06','07','08','09','林lin林']
        self.grid =QtGui.QGridLayout()

        #电影封面
        for i in range(len(films)):
            label = self.getFilmLabel(films[i])
            #self.grid.addWidget(label,i%self.rowCount,i//self.rowCount)
            button=self.getFilmButton(i)
            #self.grid.addWidget(button, i % self.rowCount, i // self.rowCount)
        ...
        # 滚动条LOADING
        # tab1 = QtGui.QWidget()
        #console = QtGui.QWidget()
        #console.setMinimumSize(1500, 600)
        self.widget.setMinimumSize(1100,28140)
    ...
    def getFilmButton(self,i):
        ...
        # p = button1.palette()
        # p.setColor(button1.backgroundRole(), Qt.white)
        # #w.setPalette(p)
